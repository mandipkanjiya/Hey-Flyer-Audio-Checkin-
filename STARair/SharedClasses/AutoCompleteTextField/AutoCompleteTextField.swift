...
open class AutoCompleteTextField:UITextField {
    ...
    fileprivate func commonInit(){
        hidesWhenEmpty = true
        autoCompleteAttributes = [NSAttributedString.Key.foregroundColor:UIColor.darkGray]
        autoCompleteAttributes = [NSAttributedString.Key.font: UIFont(name: "OpenSans-Semibold", size: 14.0)!]
